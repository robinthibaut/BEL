...
plt.subplot(222)
plt.scatter(X_train_r[:, 2], Y_train_r[:, 2], label="train", marker="*", c="b", s=50)
plt.scatter(X_test_r[:, 2], Y_test_r[:, 2], label="test", marker="*", c="r", s=50)
plt.xlabel("X comp. 1")
plt.ylabel("X comp. 2")
plt.title(
...
plt.subplot(223)
plt.scatter(X_train_r[:, 3], Y_train_r[:, 3], label="train", marker="*", c="b", s=50)
plt.scatter(X_test_r[:, 3], Y_test_r[:, 3], label="test", marker="*", c="r", s=50)
plt.xlabel("Y comp. 1")
plt.ylabel("Y comp. 2")
plt.title(
