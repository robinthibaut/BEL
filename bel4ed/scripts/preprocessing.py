...
logger.info(f"Preprocessing for {len(folders)} samples")
...
file_name = jp(Setup.Directories.data_dir, "data_structural", "predictor.pkl")
...
# Target
file_name = jp(Setup.Directories.data_dir, "data_structural", "target.pkl")
