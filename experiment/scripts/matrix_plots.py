...
mat_cov_plot(np.linalg.pinv(g @ h_cov_operator @ g.T + d_noise_covariance + d_modeling_covariance) , cmap=c, filename='Cdd_inv')
...
mat_cov_plot(h_cov_operator @ g.T @ np.linalg.pinv(g @ h_cov_operator @ g.T + d_noise_covariance + d_modeling_covariance), cmap=c, filename='mean_mid')
